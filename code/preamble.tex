...
% ----------------------------------------------------------------------------------------------------------------------
% Commands
\newcommand{\app}{\textsf{dwarfs4MOSAIC repository}\xspace}
...
\newcommand{\correcciones}[1]{\red{CORRECCIONES \textdownarrow} #1 \red{CORRECCIONES \textuparrow}}

% \rolecontent{<role>}{<admin text>}{<user text>}{<default text>}
\newcommand{\rolecontent}[4]{
	\ifthenelse{\equal{#1}{admin}}{#2}{
		\ifthenelse{\equal{#1}{user}}{#3}{#4}
	}
}
...
\captionsetup{
	...
	labelsep=period,          % Separator "Fig. 1." instead of "Fig. 1:"
